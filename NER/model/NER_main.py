...
def main():
    ...
    parser.add_argument("--data_dir", default='input/data/ner_data', type=str, required=True,
                        help="数据文件目录，因当有train.txt dev.txt")

    parser.add_argument("--vob_file", default='voidful/albert_chinese_tiny', type=str, required=True,
                        help="词表文件")

    parser.add_argument("--model_config", default='voidful/albert_chinese_tiny', type=str, required=True,
                        help="模型配置文件json文件")
    parser.add_argument("--output_dir", default='output', type=str, required=True,
                        help="输出结果的文件")

    # Other parameters
    parser.add_argument("--pre_train_model", default='voidful/albert_chinese_tiny', type=str, required=False,
    ...
    tokenizer = BertTokenizer.from_pretrained(args.vob_file, *tokenizer_inputs, **tokenizer_kwards)
