...
from transformers import BertTokenizer, BertConfig, AlbertForSequenceClassification
...
tokenizer = BertTokenizer.from_pretrained('voidful/albert_chinese_tiny',**tokenizer_kwards)


ner_model = get_ner_model(config_file ='voidful/albert_chinese_tiny',
                          pre_train_model = 'best_ner.bin', label_num = len(ner_processor.get_labels()))
ner_model = ner_model.to(device)
ner_model.eval()

    # sim_model = get_sim_model(config_file='voidful/albert_chinese_tiny',
