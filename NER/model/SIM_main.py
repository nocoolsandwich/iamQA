...
from transformers import BertConfig, BertForSequenceClassification, BertTokenizer,AlbertForSequenceClassification
    ...
    for _ in train_iterator:
        ...
        for step,batch in enumerate(epoch_iterator):
            ...
            if 0 == (step + 1) % args.gradient_accumulation_steps:
                ...
                # 每 相隔 100步，评估一次
                if global_step in range(0,1000,250):
...
def main():
    ...
    model = AlbertForSequenceClassification.from_pretrained(args.pre_train_model, **model_kwargs)
