...
from transformers import AutoConfig,BertTokenizer,BertConfig,AlbertForTokenClassification
...
class BertCrf(nn.Module):
    def __init__(self,config_name:str,model_name:str = None,num_tags: int = 2, batch_first:bool = True) -> None:
        ...
        if self.model_name is not None:
            self.bertModel = AlbertForTokenClassification.from_pretrained(self.model_name, **self.model_kwargs)
        else:
